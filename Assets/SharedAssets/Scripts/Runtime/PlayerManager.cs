...
public class PlayerManager : MonoBehaviour
{
    ...
    // NEW
    [SerializeField] private bool m_StartInFlythrough;
    //
    ...
    void Start()
    {
        ...
        // NEW
        //m_InFlythrough = m_StartInFlythrough;
        //
    ...
    {
        Debug.Log("EnableFirstPersonController()");
        if (SceneTransitionManager.IsAvailable())
        {
            SceneTransitionManager.DisableLoadedScene();
            SceneTransitionManager.StopTransition();
